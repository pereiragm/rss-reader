...
Revision ID: 021a30a6a780
Revises: 
Create Date: 2023-05-18 21:35:46.783069
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_feed_last_build_date'), 'feed', ['last_build_date'], unique=False)
